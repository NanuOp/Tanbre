...
FRAMEWORK_DIR = env.PioPlatform().get_package_dir("framework-arduinoespressif32-libs") if env.PioPlatform().get_package_dir("framework-arduinoespressif32-libs") else env.PioPlatform().get_package_dir("framework-arduinoespressif32")
