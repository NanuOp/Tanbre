...
#define RADIO_CE_PIN_1  (bruceConfigPins.NRF24_bus.io0)
#define RADIO_CSN_PIN_1 (bruceConfigPins.NRF24_bus.cs)
#define RADIO_CE_PIN_2  ((gpio_num_t)-1)
#define RADIO_CSN_PIN_2 ((gpio_num_t)-1)
#define RADIO_CE_PIN_3  ((gpio_num_t)-1)
#define RADIO_CSN_PIN_3 ((gpio_num_t)-1)
...
void runSigkill() {
    runNyanModule(sigkillSetup, sigkillLoop, nullptr);
}
