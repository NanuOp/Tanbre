...
#if defined(TANBRE_WATCH)
    String filename = "/TanbrePCAP/handshakes/HS_" + String(macStr) + "_" + hs.ssid + ".pcap";
#else
            ...
            std::vector<Option> options = {
                ...
                {"View Captures",
                 ...
                 [&]() {
                              FS *fs;
#if defined(TANBRE_WATCH)
                              if (getFsStorage(fs) && fs->exists("/TanbrePCAP/handshakes")) {
                                  loopSD(*fs, false, "PCAP", "/TanbrePCAP/handshakes");
#else
