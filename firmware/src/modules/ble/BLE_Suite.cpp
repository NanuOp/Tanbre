...
String selectFileFromSD() {
    ...
    bool exitMenu = false;
    int menuStartY = (tftHeight <= 80) ? 20 : 60;
    int menuItemHeight = (tftHeight <= 80) ? 10 : 25;
    int maxVisibleItems = (tftHeight <= 80) ? 3 : ((tftHeight - menuStartY - 50) / menuItemHeight);
    ...
    while (!exitMenu) {
        if (selected != lastSelected || scrollOffset != lastScrollOffset) {
            ...
            tft.setTextSize(FM);
            tft.setCursor((tftWidth - tft.textWidth("SD CARD FILES")) / 2, (tftHeight <= 80) ? 5 : 15);
            tft.print("SD CARD FILES");
            tft.setTextSize(FP);

            tft.setTextColor(TFT_YELLOW, bruceConfig.bgColor);
            tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 14 : 40);
            tft.print("Found: ");
            tft.print(fileCount);
            tft.print(" files");
            ...
            for (int i = 0; i < maxVisibleItems && (scrollOffset + i) < fileCount; i++) {
                ...
                if (yPos + menuItemHeight > tftHeight - ((tftHeight <= 80) ? 10 : 45)) break;

                if (fileIdx == selected) {
                    tft.fillRect((tftHeight <= 80) ? 8 : 20, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 40), menuItemHeight - ((tftHeight <= 80) ? 1 : 3), TFT_WHITE);
                    tft.setTextColor(TFT_BLACK, TFT_WHITE);
                    tft.setCursor((tftHeight <= 80) ? 10 : 25, yPos + ((tftHeight <= 80) ? 1 : 8));
                    tft.print("> ");
                } else {
                    tft.fillRect((tftHeight <= 80) ? 8 : 20, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 40), menuItemHeight - ((tftHeight <= 80) ? 1 : 3), bruceConfig.bgColor);
                    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
                    tft.setCursor((tftHeight <= 80) ? 10 : 25, yPos + ((tftHeight <= 80) ? 1 : 8));
                    tft.print("  ");
                }
                ...
                int maxChars = (tftHeight <= 80) ? 18 : 28;
                if (displayName.length() > maxChars) displayName = displayName.substring(0, maxChars - 3) + "...";
                tft.print(displayName);
            }

            if (fileCount > maxVisibleItems) {
                tft.setTextColor(TFT_CYAN, bruceConfig.bgColor);
                tft.setCursor(tftWidth - ((tftHeight <= 80) ? 12 : 25), menuStartY + ((tftHeight <= 80) ? 1 : 5));
                if (scrollOffset > 0) tft.print("^");
                tft.setCursor(tftWidth - ((tftHeight <= 80) ? 12 : 25), menuStartY + (maxVisibleItems * menuItemHeight) - ((tftHeight <= 80) ? 9 : 20));
...
String getScriptFromUser() {
    ...
    while (!exitMenu) {
        if (selected != lastSelected || scrollOffset != lastScrollOffset) {
            ...
            tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
            tft.setTextSize(FM);
            tft.setCursor((tftWidth - tft.textWidth("SELECT SCRIPT")) / 2, (tftHeight <= 80) ? 5 : 15);
...
String selectTargetFromScan(const char *title) {
    ...
    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
    tft.setTextSize(FM);
    tft.setCursor((tftWidth - tft.textWidth(title)) / 2, (tftHeight <= 80) ? 5 : 15);
    tft.print(title);
    tft.setTextSize(FP);

    tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 22 : 60);
    ...
    if (!pBLEScan) {
        ...
        tft.setTextSize(FM);
        tft.setCursor((tftWidth - tft.textWidth("ERROR")) / 2, (tftHeight <= 80) ? 5 : 15);
        tft.print("ERROR");
        tft.setTextSize(FP);
        tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 25 : 60);
    ...
    tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 22 : 100);
    tft.print("Scanning for devices...");

    const int ACTIVE_SCAN_TIME = 15, PASSIVE_SCAN_TIME = 15;

    tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 32 : 120);
    ...
    tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 42 : 140);
    ...
    if (results.getCount() == 0) {
        ...
        tft.setTextSize(FM);
        tft.setCursor((tftWidth - tft.textWidth("NO DEVICES")) / 2, (tftHeight <= 80) ? 5 : 15);
        tft.print("NO DEVICES");
        tft.setTextSize(FP);
        tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 20 : 60);
        tft.print("No BLE devices found!");
        tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 30 : 80);
        tft.print("Make sure BLE devices are");
        tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 40 : 100);
        tft.print("turned on and in range.");
        tft.setCursor((tftHeight <= 80) ? 8 : 20, (tftHeight <= 80) ? 50 : 130);
    ...
    int maxVisibleDevices = (tftHeight <= 80) ? 3 : 3;
    int deviceItemHeight = (tftHeight <= 80) ? 10 : 30;
    int menuStartY = (tftHeight <= 80) ? 20 : 60;
    ...
    while (!exitLoop) {
        if (selectedIdx != lastSelected || scrollOffset != lastScrollOffset) {
            ...
            tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
            tft.setTextSize(FM);
            tft.setCursor((tftWidth - tft.textWidth("SELECT DEVICE")) / 2, (tftHeight <= 80) ? 5 : 15);
            ...
            for (int i = 0; i < maxVisibleDevices && (scrollOffset + i) < deviceCount; i++) {
                ...
                int maxChars = (tftHeight <= 80) ? 12 : 18;
                if (displayText.length() > maxChars) displayText = displayText.substring(0, maxChars - 3) + "...";
                displayText += " (" + String(rssi) + ")";
                if (fastPair) displayText += " [FP]";
                if (hasHFP) displayText += " [HFP]";

                int yPos = menuStartY + (i * deviceItemHeight);
                if (yPos + deviceItemHeight > tftHeight - ((tftHeight <= 80) ? 10 : 45)) break;

                if (i == selectedIdx - scrollOffset) {
                    tft.fillRect((tftHeight <= 80) ? 8 : 15, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 30), deviceItemHeight - ((tftHeight <= 80) ? 1 : 5), TFT_WHITE);
                    tft.setTextColor(TFT_BLACK, TFT_WHITE);
                    tft.setCursor((tftHeight <= 80) ? 10 : 20, yPos + ((tftHeight <= 80) ? 1 : 10));
                    tft.print("> ");
                } else {
                    tft.fillRect((tftHeight <= 80) ? 8 : 15, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 30), deviceItemHeight - ((tftHeight <= 80) ? 1 : 5), bruceConfig.bgColor);
                    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
                    tft.setCursor((tftHeight <= 80) ? 10 : 20, yPos + ((tftHeight <= 80) ? 1 : 10));
                    tft.print("  ");
                }
            ...
            if (deviceCount > maxVisibleDevices) {
                tft.setTextColor(TFT_CYAN, bruceConfig.bgColor);
                tft.setCursor(tftWidth - ((tftHeight <= 80) ? 12 : 25), menuStartY + ((tftHeight <= 80) ? 1 : 10));
                if (scrollOffset > 0) tft.print("^");
                tft.setCursor(tftWidth - ((tftHeight <= 80) ? 12 : 25), menuStartY + (maxVisibleDevices * deviceItemHeight) - ((tftHeight <= 80) ? 9 : 15));
...
void showWelcomeScreen() {
    ...
    tft.setCursor((tftWidth - tft.textWidth("TANBRE")) / 2, (tftHeight <= 80) ? 10 : 40);
    tft.print("TANBRE");
#else
    tft.setCursor((tftWidth - tft.textWidth("BRUCE")) / 2, (tftHeight <= 80) ? 10 : 40);
    tft.print("BRUCE");
#endif

    tft.setTextColor(TFT_BLUE, TFT_GRAY);
    tft.setTextSize(FP);
    tft.setCursor((tftWidth - tft.textWidth("BLE SUITE")) / 2, (tftHeight <= 80) ? 25 : 90);
    tft.print("BLE SUITE");

    tft.setTextColor(TFT_GREEN, TFT_GRAY);
    tft.setTextSize(FP);
    tft.setCursor((tftWidth - tft.textWidth("v2.0b")) / 2, (tftHeight <= 80) ? 40 : 130);
    tft.print("v2.0b");
    delay(1500);
...
void BleSuiteMenu() {
    ...
    int menuStartY = (tftHeight <= 80) ? 20 : 60;
    int menuItemHeight = (tftHeight <= 80) ? 10 : 25;
    int maxVisible = (tftHeight <= 80) ? 3 : ((tftHeight - 80) / 25);
    ...
    while (true) {
        if (selected != lastSelected || scrollOffset != lastScrollOffset) {
            ...
            tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
            tft.setTextSize(FM);
            tft.setCursor((tftWidth - tft.textWidth("BLE SUITE")) / 2, (tftHeight <= 80) ? 5 : 15);
            tft.print("BLE SUITE");
            tft.setTextSize(FP);
            ...
            for (int i = 0; i < maxVisible && (scrollOffset + i) < MENU_ITEMS; i++) {
                ...
                if (idx == selected) {
                    tft.fillRect((tftHeight <= 80) ? 8 : 20, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 40), menuItemHeight - ((tftHeight <= 80) ? 1 : 5), TFT_WHITE);
                    tft.setTextColor(TFT_BLACK, TFT_WHITE);
                    tft.setCursor((tftHeight <= 80) ? 10 : 25, yPos + ((tftHeight <= 80) ? 1 : 5));
                    tft.print("> ");
                } else {
                    tft.fillRect((tftHeight <= 80) ? 8 : 20, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 40), menuItemHeight - ((tftHeight <= 80) ? 1 : 5), bruceConfig.bgColor);
                    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
                    tft.setCursor((tftHeight <= 80) ? 10 : 25, yPos + ((tftHeight <= 80) ? 1 : 5));
                    tft.print("  ");
                }
                String itemText = String(idx + 1) + ". " + menuItems[idx];
                int maxChars = (tftHeight <= 80) ? 18 : 28;
                if (itemText.length() > maxChars) itemText = itemText.substring(0, maxChars - 3) + "...";
                tft.print(itemText);
            }
            ...
            if (MENU_ITEMS > maxVisible) {
                ...
                tft.setCursor(tftWidth - ((tftHeight <= 80) ? 12 : 25), menuStartY + ((tftHeight <= 80) ? 1 : 5));
                if (scrollOffset > 0) tft.print("^");
                tft.setCursor(tftWidth - ((tftHeight <= 80) ? 12 : 25), menuStartY + (maxVisible * menuItemHeight) - ((tftHeight <= 80) ? 9 : 10));
...
int showSubMenu(const char *title, const char *options[], int optionCount) {
    ...
    while (true) {
        if (selected != lastSelected || scrollOffset != lastScrollOffset) {
            tft.fillRect((tftHeight <= 80) ? 8 : 20, menuStartY, tftWidth - ((tftHeight <= 80) ? 16 : 40), tftHeight - menuStartY - ((tftHeight <= 80) ? 10 : 40), bruceConfig.bgColor);
...
void runAudioControlTest(NimBLEAddress target) {
    ...
    int selectedTest = 0;
    int lastSelected = -1;
    int menuStartY = (tftHeight <= 80) ? 20 : 90;
    int menuItemHeight = (tftHeight <= 80) ? 10 : 35;
    int maxTests = (tftHeight <= 80) ? 3 : std::min(AUDIO_TESTS, 5);
    ...
    while (!exitSubmenu) {
        if (selectedTest != lastSelected) {
            ...
            tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
            tft.setTextSize(FM);
            tft.setCursor((tftWidth - tft.textWidth("AUDIO CONTROL TEST")) / 2, (tftHeight <= 80) ? 5 : 15);
            ...
            for (int i = 0; i < maxTests; i++) {
                ...
                if (i == selectedTest) {
                    tft.fillRect((tftHeight <= 80) ? 8 : 30, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 60), menuItemHeight - ((tftHeight <= 80) ? 1 : 5), TFT_WHITE);
                    tft.setTextColor(TFT_BLACK, TFT_WHITE);
                    tft.setCursor((tftHeight <= 80) ? 10 : 40, yPos + ((tftHeight <= 80) ? 1 : 10));
                    tft.print("> ");
                } else {
                    tft.fillRect((tftHeight <= 80) ? 8 : 30, yPos, tftWidth - ((tftHeight <= 80) ? 16 : 60), menuItemHeight - ((tftHeight <= 80) ? 1 : 5), (tftHeight <= 80) ? bruceConfig.bgColor : TFT_DARKGREY);
                    tft.setTextColor(TFT_WHITE, (tftHeight <= 80) ? bruceConfig.bgColor : TFT_DARKGREY);
                    tft.setCursor((tftHeight <= 80) ? 10 : 40, yPos + ((tftHeight <= 80) ? 1 : 10));
                    tft.print("  ");
                }
                tft.print(displayName);
...
void showAttackProgress(const char *message, uint16_t color) {
    ...
    int lineHeight = (tftHeight <= 80) ? 10 : 20;
    int yPos = (tftHeight <= 80) ? 22 : 80;
    int start = 0;
    int len = msg.length();
    ...
    while (start < len) {
        ...
        yPos += lineHeight;
        if (yPos > tftHeight - ((tftHeight <= 80) ? 15 : 60)) break;
    }

    static uint8_t spinnerPos = 0;
    const char *spinner = "|/-\\";
    tft.setCursor(tftWidth - ((tftHeight <= 80) ? 15 : 40), (tftHeight <= 80) ? 22 : 80);
    tft.print(spinner[spinnerPos % 4]);
    spinnerPos++;

    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
    tft.setCursor(20, tftHeight - ((tftHeight <= 80) ? 12 : 30));
...
void showAttackResult(bool success, const char *message) {
    if (success) {
        ...
        tft.setTextSize(FM);
        tft.setCursor((tftWidth - tft.textWidth("SUCCESS")) / 2, (tftHeight <= 80) ? 5 : 15);
        tft.print("SUCCESS");
        tft.setTextSize(FP);
        ...
        tft.setTextColor(TFT_WHITE, TFT_RED);
        tft.setTextSize(FM);
        tft.setCursor((tftWidth - tft.textWidth("FAILED")) / 2, (tftHeight <= 80) ? 5 : 15);
        tft.print("FAILED");
        tft.setTextSize(FP);
        tft.setTextColor(TFT_WHITE, TFT_RED);
    }
    ...
    if (message) {
        ...
        while (start < len) {
            ...
            yPos += lineHeight;
            if (yPos > tftHeight - ((tftHeight <= 80) ? 15 : 100)) break;
        }
    } else {
        tft.setCursor(20, (tftHeight <= 80) ? 22 : 80);
        tft.print(success ? "Attack successful!" : "Attack failed");
    }

    tft.setTextColor(TFT_WHITE, success ? TFT_GREEN : TFT_RED);
    tft.setCursor(20, tftHeight - ((tftHeight <= 80) ? 12 : 35));
...
bool confirmAttack(const char *targetName) {
    ...
    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
    tft.setTextSize(FM);
    tft.setCursor((tftWidth - tft.textWidth("CONFIRM ATTACK")) / 2, (tftHeight <= 80) ? 5 : 15);
    tft.print("CONFIRM ATTACK");
    tft.setTextSize(FP);

    tft.setCursor(20, (tftHeight <= 80) ? 22 : 60);
    tft.print("Target: ");

    String targetStr = targetName;
    int maxChars = (tftHeight <= 80) ? 14 : 30;
    if (targetStr.length() > maxChars) {
        tft.println(targetStr.substring(0, maxChars - 3) + "...");
    } else {
...
bool requireSimpleConfirmation(const char *message) {
    ...
    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
    tft.setTextSize(FM);
    tft.setCursor((tftWidth - tft.textWidth("CONFIRM")) / 2, (tftHeight <= 80) ? 5 : 15);
    tft.print("CONFIRM");
    tft.setTextSize(FP);

    tft.fillRect(20, (tftHeight <= 80) ? 20 : 50, tftWidth - 40, (tftHeight <= 80) ? 30 : 80, bruceConfig.bgColor);
    String msgStr = message;

    int maxWidth = tftWidth - 40;
    int lineHeight = (tftHeight <= 80) ? 10 : 20;
    int yPos = (tftHeight <= 80) ? 22 : 60;
    int start = 0;
    ...
    while (start < len) {
        ...
        yPos += lineHeight;
        if (yPos > tftHeight - ((tftHeight <= 80) ? 15 : 30)) break;
    }
...
int8_t showAdaptiveMessage(
    ...
    tft.setTextColor(TFT_WHITE, bruceConfig.bgColor);
    tft.setTextSize(FM);
    tft.setCursor((tftWidth - tft.textWidth("MESSAGE")) / 2, (tftHeight <= 80) ? 5 : 15);
    tft.print("MESSAGE");
    tft.setTextSize(FP);
...
void showWarningMessage(const char *message) {
    ...
    tft.setTextColor(TFT_BLACK, TFT_YELLOW);
    tft.setTextSize(FM);
    tft.setCursor((tftWidth - tft.textWidth("WARNING")) / 2, (tftHeight <= 80) ? 5 : 15);
    tft.print("WARNING");
    tft.setTextSize(FP);
    tft.setTextColor(TFT_BLACK, TFT_YELLOW);
    tft.fillRect(20, (tftHeight <= 80) ? 20 : 60, tftWidth - 40, (tftHeight <= 80) ? 30 : 100, TFT_YELLOW);

    String msgStr = message;
    int maxWidth = tftWidth - 40;
    int lineHeight = (tftHeight <= 80) ? 10 : 20;
    int yPos = (tftHeight <= 80) ? 22 : 70;
    int start = 0;
    int len = msgStr.length();
    ...
    while (start < len) {
        ...
        yPos += lineHeight;
        if (yPos > tftHeight - ((tftHeight <= 80) ? 15 : 40)) break;
    }
...
void showErrorMessage(const char *message) {
    ...
    tft.setTextSize(FP);
    tft.setTextColor(TFT_WHITE, TFT_RED);
    tft.fillRect(20, (tftHeight <= 80) ? 20 : 60, tftWidth - 40, (tftHeight <= 80) ? 30 : 100, TFT_RED);
...
void showSuccessMessage(const char *message) {
    ...
    tft.setTextSize(FP);
    tft.setTextColor(TFT_BLACK, TFT_GREEN);
    tft.fillRect(20, (tftHeight <= 80) ? 20 : 60, tftWidth - 40, (tftHeight <= 80) ? 30 : 100, TFT_GREEN);
...
void showDeviceInfoScreen(
    ...
    int yPos = (tftHeight <= 80) ? 22 : 60;
    int lineHeight = (tftHeight <= 80) ? 10 : 20;
    int maxLines = (tftHeight <= 80) ? 4 : 8;

    for (int i = 0; i < std::min((int)lines.size(), maxLines); i++) {
        if (yPos + lineHeight > tftHeight - ((tftHeight <= 80) ? 15 : 45)) break;
        ...
        while (start < len) {
            ...
            lineY += lineHeight;
            if (lineY > tftHeight - ((tftHeight <= 80) ? 15 : 45)) break;
        }
        yPos = lineY;
    }
