...
#include "modules/wifi/wifiscan.h"
#include "modules/wifi/beacon_spam.h"
#include "modules/wifi/deauth_scanner.h"
#include "modules/wifi/nyan_evil_portal.h"
#include "modules/wifi/channel_analyzer.h"
#include "modules/wifi/pineapple_detector.h"
#include "modules/wifi/sigkill.h"
#endif
...
void WifiMenu::optionsMenu() {
    ...
    options.push_back({"WiFi Scanner", runWifiscan});
    options.push_back({"Beacon Spam", runBeaconSpam});
    options.push_back({"Deauth Scanner", runDeauthScanner});
    options.push_back({"nyanBOX Portal", runNyanEvilPortal});
    options.push_back({"Channel Analyzer", runChannelAnalyzer});
    options.push_back({"Pineapple Detect", runPineappleDetector});
    options.push_back({"Sigkill Attack", runSigkill});
#endif
