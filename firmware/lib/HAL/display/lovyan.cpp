...
#error "To use LOVYAN_I2C_BUS, need to define: TFT_I2C_PORT, TFT_I2C_WRITE, TFT_I2C_READ, TFT_SDA, TFT_SCL, TFT_ADDR"
#endif
...
#error "To use LOVYAN_8PARALLEL_BUS, need to define: TFT_WRITE_FREQ, TFT_WR, TFT_RD, TFT_DC, TFT_D0..D7"
#endif
        cfg.freq_write = TFT_WRITE_FREQ;
        cfg.pin_wr = TFT_WR;
        cfg.pin_rd = TFT_RD;
...
void tft_display::fillScreen(uint32_t color) {
    RUN_ON_MUTEX(lgfx::LGFX_Device::fillScreen((uint16_t)color));
}
